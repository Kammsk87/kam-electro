...
- Finam and MOEX ISS daily bars are highly correlated, but isolated daily close differences are too large to ignore.
- Daily session and close convention must be resolved before a broker-data backtest can become authoritative.
...
- source close/session convention is understood;
